...
if (isset($_POST['submit'])) {
    ...
    if ($payment_type == 'payu') {
        $MERCHANT_KEY = "gtKFFx";//first to create a account  in Payu then we will get this id
        $SALT = "eCwWELxi";//first to create a account  in Payu then we will get this id
        $hash_string = '';
